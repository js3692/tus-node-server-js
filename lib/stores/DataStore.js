...
class DataStore {
    ...
    /**
     * Called in POST requests. This method saves the metadata to the
     * DataStore, so that it could be used in subsequent HEAD requests.
     *
     * http://tus.io/protocols/resumable-upload.html#creation
     *
    ...
    saveMetadata(file_name, metadata) {
        console.log(`[DataStore] save metadata: ${file_name}.json`);
    }

    /**
     * Called in HEAD requests. This method should return the metadata
